...
})({"fEcKl":[function(require,module,exports) {
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4) {
            if (xhr.status === 200) {
                ...
                if (firstPages.includes(page)) animateElements();
                if (decoPages.includes(page)) {
                    initializeDeco();
                    Swiperbox();
                }
                if (page === "next.html") initializeNext();
                if (callback) callback();
            } else console.error("Error loading page:", xhr.status, xhr.statusText);
        }
    };
    xhr.send();
}
...
},{"lodash":"3qBDj","gsap":"fPSuC","swiper":"iM6UL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
},{"./ssr-window.esm.mjs":"th8PY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fEcKl","gGcsZ"], "gGcsZ", "parcelRequire94cb")
